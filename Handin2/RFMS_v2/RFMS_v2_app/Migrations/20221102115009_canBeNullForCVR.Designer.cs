...
namespace RFMS_v2_app.Migrations
{
    ...
    [Migration("20221102115009_canBeNullForCVR")]
    partial class canBeNullForCVR
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RFMS_v2_app.Models.Item", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RFMS_v2_app.Models.Item", b =>
                {
                    b.HasOne("RFMS_v2_app.Models.Facility", null)
                        .WithMany("Items")
                        .HasForeignKey("FacilityId");
                });
